...
declare module '$env/static/private' {
	...
	export const npm_package_devDependencies_joi: string;
	...
	export const npm_package_devDependencies_vanillajs_datepicker: string;
	export const npm_package_devDependencies__hapi_tlds: string;
	...
	export const npm_package_devDependencies__modyfi_vite_plugin_yaml: string;
	...
	export const npm_package_devDependencies__steeze_ui_material_design_icons: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_devDependencies_joi: string;
		...
		npm_package_devDependencies_vanillajs_datepicker: string;
		npm_package_devDependencies__hapi_tlds: string;
		LS_COLORS: string;
		...
		npm_package_devDependencies__modyfi_vite_plugin_yaml: string;
		...
		npm_package_devDependencies__steeze_ui_material_design_icons: string;
