<template>
    <div>
        <template v-if="config.repeatable">
            ...
            >
                <h2 class="tw-text-lg tw-mb-4">
                    {{ config.config.repeatable_title[$i18n.locale] }}
                </h2>
...
watch(arrayValue, (v) => emitter("update:modelValue", arrayValue), {
    deep: true,
});
</script>
