...
export const navigationItems = computed(() =>
{
    ...
    return [
        ...
        {icon: 'mdi-shape-outline', to: {name: "Categories"}, text: i18n.global.t('categories.title'), parent: '', permission: 'read_category'},
        ...
        {icon: 'mdi-email-outline', to: {name: 'Emails'}, parent: '', text: i18n.global.t('emails.title'), permission:'read_emails'},
