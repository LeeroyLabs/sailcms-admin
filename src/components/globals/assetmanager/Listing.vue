<template>
    <div class="tw-relative tw-h-full">
        <template v-if="!loading && files.length > 0">
            ...
            <div v-if="displayMode === 'list'" :class="{'tw-bg-gray-800 tw-text-white': $vuetify.theme.name !== 'light', 'tw-bg-gray-100': $vuetify.theme.name === 'light'}" class="tw-w-full tw-max-w-full tw-max-h-full tw-overflow-y-auto tw-text-black tw-p-6 tw-grid tw-grid-cols-2 tw-gap-y-2 tw-gap-x-8">
