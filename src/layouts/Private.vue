        ...
        <v-card>
            <v-layout class="tw-flex tw-flex-col tw-h-screen">
                ...
                <v-main :scrollable="true" id="mainSection" class="tw-flex tw-flex-col tw-h-full" :class="{'tw-bg-gray-200': $vuetify.theme.name === 'light', 'tw-bg-[#111111]': $vuetify.theme.name === 'dark'}">
                    <div id="pagecontrols" class="tw-flex tw-flex-row tw-items-center tw-pr-4 tw-pt-4" :class="{'tw-bg-gray-200': $vuetify.theme.name === 'light', 'tw-bg-[#111111]': $vuetify.theme.name === 'dark'}">
